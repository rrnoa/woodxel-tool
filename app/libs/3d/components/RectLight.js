...
class ColorGUIHelper {
  ...
  function makeXYZGUI(gui, vector3, name, onChangeFn) {
    ...
    folder.add(new DegRadHelper(light.rotation, 'x'), 'value', -180, 180).name('x rotation');
    folder.add(new DegRadHelper(light.rotation, 'y'), 'value', -180, 180).name('y rotation');
    folder.add(new DegRadHelper(light.rotation, 'z'), 'value', -180, 180).name('z rotation');
